...
def callback(iter, t, latents):
    with torch.no_grad():
        ...
        image[0].save(str(iter//10)+str(iter%10)+".png")
...
result = pipe(prompt = "girl eating pizza", callback=callback, callback_steps=1, width  = img_size, height = img_size, num_inference_steps = inference)
